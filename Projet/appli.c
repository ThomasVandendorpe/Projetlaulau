...
/* 
vérifie que le num est compris valide (compris entre -3 et width)
*/


/*
ajoute un jeton dans la colonne numero num du board, joué par le joueur character
*/

/* nombre de X et 0 */


/* sortie/entree fichier save ...*/
